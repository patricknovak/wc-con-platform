...
const opportunities = [
  {
    id: 1,
    title: 'Jasper Campground Reconstruction — Aggregate Supply',
    source: 'Parks Canada / Jasper Recovery',
    deadline: '2026-05-15',
    estimatedValue: '$500,000 - $1,200,000',
    description:
      'Aggregate and trucking supply for Jasper National Park campground reconstruction following the 2024 wildfire. Includes road crush, pit run, washed rock, and sand for campground pads, access roads, and drainage infrastructure.',
    type: 'RFQ',
    status: 'Active',
  },
  {
    id: 2,
    title: 'Yellowhead Mainline Pipeline — Bedding Aggregate',
    source: 'Yellowhead Mainline Pipeline LP',
    deadline: '2026-06-30',
    estimatedValue: '$300,000 - $750,000',
    description:
      'Supply of pipeline bedding aggregate, select fill, and padding material for the Yellowhead Mainline Natural Gas Pipeline construction in Yellowhead County. Includes trucking and stockpile management.',
    type: 'RFP',
    status: 'Active',
  },
  {
    id: 3,
    title: 'Municipal Water & Sewer Upgrades — Hinton',
    source: 'Town of Hinton',
    deadline: '2026-04-30',
    estimatedValue: '$150,000 - $300,000',
    description:
      'Aggregate supply and hauling services for water main replacement and sewer line upgrades in Hinton. Requires road crush, bedding sand, and backfill material with delivery to multiple work zones.',
    type: 'RFQ',
    status: 'Active',
  },
  {
    id: 4,
    title: 'Highway 16 Shoulder Rehabilitation — Edson to Hinton',
    source: 'Alberta Transportation',
    deadline: '2026-05-31',
    estimatedValue: '$200,000 - $400,000',
    description:
      'Gravel supply and delivery for Highway 16 shoulder rehabilitation between Edson and Hinton. Requires Class 2 road crush and compactable gravel meeting ATP specifications.',
    type: 'RFQ',
    status: 'Active',
  },
  {
    id: 5,
    title: 'Commercial Facility Maintenance — Yellowhead County',
    source: 'Yellowhead County',
    deadline: '2026-04-15',
    estimatedValue: '$50,000 - $120,000',
    description:
      'Equipment rental and site maintenance services for county-owned commercial facilities. Includes grading, gravel resurfacing, drainage maintenance, and snow removal preparation.',
    type: 'RFP',
    status: 'Active',
  },
  {
    id: 6,
    title: 'Oil & Gas Lease Reclamation — Multiple Sites',
    source: 'Major Energy Producer (Confidential)',
    deadline: '2026-07-15',
    estimatedValue: '$100,000 - $250,000',
    description:
      'Environmental remediation and reclamation services for 5 decommissioned well sites in the Hinton-Edson corridor. Includes contaminated soil removal, regrading, topsoil placement, and revegetation.',
    type: 'RFP',
    status: 'Active',
  },
];
