      ...
      <section className="section-padding bg-brand-charcoal text-white">
        <div className="container-wide">
          ...
          <h1 className="font-heading text-4xl md:text-5xl font-bold mb-4">
            Aggregate Supply &amp; Trucking in Drayton Valley, AB
          </h1>
          <p className="text-lg text-gray-200 max-w-2xl">
            Extending our services to Drayton Valley and Brazeau County. West Central
            Contracting delivers quality aggregates for construction, oil and gas
            operations, and municipal projects in the Drayton Valley region.
          </p>
        </div>
      </section>
        ...
        <div className="container-wide">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg border border-gray-200">
              ...
              <h3 className="font-heading text-xl font-bold text-brand-charcoal mb-2">2.5 Hr from Hinton</h3>
              <p className="text-gray-700">
                Located southeast via Highway 16 and Highway 22, Drayton Valley is
                part of our expanding service territory in Brazeau County.
              </p>
            </div>
            <div className="bg-white p-8 rounded-lg border border-gray-200">
              <Clock className="w-8 h-8 text-brand-red mb-4" />
              <h3 className="font-heading text-xl font-bold text-brand-charcoal mb-2">Advance Scheduling</h3>
              <p className="text-gray-700">
                Deliveries to Drayton Valley are coordinated in advance for optimal
                logistics. Contact dispatch to schedule your delivery window.
              </p>
            </div>
            <div className="bg-white p-8 rounded-lg border border-gray-200">
              <TrendingUp className="w-8 h-8 text-brand-red mb-4" />
              <h3 className="font-heading text-xl font-bold text-brand-charcoal mb-2">Expansion Market</h3>
              <p className="text-gray-700">
                As we grow our Drayton Valley presence, we offer competitive bulk
                pricing for large construction and oil and gas projects.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-8 rounded-lg border-l-4 border-brand-red shadow-md">
              ...
              <p className="text-gray-700 italic mb-4">
                &ldquo;We brought in West Central Contracting for a large Brazeau County
                road project. Even at the distance, their pricing was competitive and
                the material quality matched their reputation.&rdquo;
              </p>
              <p className="font-semibold text-brand-charcoal">Brazeau County Project Coordinator</p>
            </div>
            <div>
      ...
      <section className="section-padding bg-brand-red text-white">
        <div className="container-wide text-center">
          <h2 className="font-heading text-3xl font-bold mb-4">
            Need Materials Delivered to Drayton Valley?
          </h2>
          <p className="text-lg mb-8 max-w-2xl mx-auto text-red-100">
            From oil and gas site work to Brazeau County construction, we deliver
            quality aggregates to the Drayton Valley area. Get a quote today.
          </p>
