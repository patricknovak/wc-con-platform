...
const quotes = [
  ...
  {
    id: 'QT-2024-154',
    customer: 'Mountain View Construction',
    total: '$15,300',
  ...
  {
    id: 'QT-2024-153',
    customer: 'Jasper Equipment Rentals',
    total: '$5,200',
  ...
  {
    id: 'QT-2024-152',
    customer: 'Parkland Services Inc',
    total: '$3,100',
            ...
            {filteredQuotes.map((quote) => (
              <tr key={quote.id} className="table-row">
                ...
                <td className="px-6 py-4 text-sm text-gray-600">
                  {format(quote.created, 'MMM d, yyyy')}
                </td>
                <td className="px-6 py-4 text-sm">
