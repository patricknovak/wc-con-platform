...
const businesses: Business[] = [
  ...
  {
    id: 'BUS-002',
    name: 'Mountain View Equipment Rentals',
    ...
    <div className="p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <p className="text-3xl font-bold text-brand-secondary mt-2">
            {businesses.filter((b) => b.status === 'featured').length}
          </p>
        </div>
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          >
            ...
            {business.status === 'pending' && (
              <div className="flex gap-2">
                <button className="flex-1 btn btn-primary flex items-center justify-center gap-2 text-sm">
      ...
      {filteredBusinesses.length === 0 && (
        <div className="text-center py-12">
          <p className="text-gray-600">No businesses in this category</p>
        </div>
      )}
    </div>
  );
