...
const recentUploads: UploadedDoc[] = [
  {
    id: 'DOC-047',
    name: 'Q1 2026 Pricing Update - Aggregates.pdf',
    uploadedAt: new Date(Date.now() - 2 * 60 * 60000),
    itemsProcessed: 52,
  },
  {
    id: 'DOC-046',
    name: 'Winter Equipment Rental Rates.pdf',
    uploadedAt: new Date(Date.now() - 8 * 60 * 60000),
    itemsProcessed: 31,
  },
  {
    id: 'DOC-045',
    name: 'Labor Rate Adjustments 2026.pdf',
    uploadedAt: new Date(Date.now() - 1 * 24 * 60 * 60000),
    itemsProcessed: 18,
  },
  {
    id: 'DOC-044',
    name: 'Bulk Material Discounting Schedule.pdf',
...
const insights = [
  {
    id: 1,
    title: 'Pricing Trend: Crushed Stone',
    description:
      'Average price trending up 2.3% month-over-month. Consider adjusting quotes accordingly.',
    icon: '📈',
  },
  {
    id: 2,
    title: 'Seasonal Demand: Equipment Rental',
    description:
      'Spring equipment rentals historically see 35% higher demand. Recommend increasing rates in Q2.',
    icon: '🔄',
  },
  {
    id: 3,
    title: 'Customer Segment: Municipal Buyers',
    description:
      'Municipal contracts show 28% longer lead times. Budget 4-6 weeks for municipal RFP responses.',
    icon: '🏛️',
  },
];
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 mb-8">
        <div className="border-2 border-dashed border-gray-300 rounded-lg p-12 text-center hover:border-brand-primary transition-colors cursor-pointer">
          ...
          <p className="text-gray-600 mb-4">
            Drag and drop PDF, Word, or Excel files to add to your knowledge base
          </p>
                ...
                <div className="flex items-start gap-3 flex-1">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      Uploaded {format(doc.uploadedAt, 'MMM d, yyyy h:mm a')}
                    </p>
                  </div>
                </div>
                <div className="text-right flex-shrink-0">
                  <p className="text-sm font-semibold text-gray-900">
                    {doc.itemsProcessed} items
                  </p>
